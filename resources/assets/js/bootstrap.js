...
(function(global, factory) {
    ...
    var EventHandler = {
        ...
        off: function off(element, originalTypeEvent, handler, delegationFn) {
            ...
            Object.keys(storeElementEvent).forEach(function(keyHandlers) {
                ...
                if (
                    !inNamespace ||
                    originalTypeEvent.indexOf(handlerKey) > -1
                ) {
    ...
    var Button =
        ...
        (function() {
            ...
            _proto.toggle = function toggle() {
                ...
                if (rootElement) {
                    var input = SelectorEngine.findOne(
                        Selector$1.INPUT,
                        this._element
                    );
    ...
    EventHandler.on(
        ...
        Selector$1.DATA_TOGGLE_CARROT,
        function(event) {
            var button = SelectorEngine.closest(
                event.target,
                Selector$1.BUTTON
            );
    ...
    var Carousel =
        ...
        (function() {
            ...
            _proto.pause = function pause(event) {
                ...
                if (
                    SelectorEngine.findOne(Selector$2.NEXT_PREV, this._element)
                ) {
            ...
            _proto._addEventListeners = function _addEventListeners() {
                ...
                if (this._config.keyboard) {
                    EventHandler.on(this._element, Event$3.KEYDOWN, function(
                        event
                    ) {
                ...
                if (this._config.pause === "hover") {
                    EventHandler.on(this._element, Event$3.MOUSEENTER, function(
                        event
                    ) {
                        return _this2.pause(event);
                    });
                    EventHandler.on(this._element, Event$3.MOUSELEAVE, function(
                        event
                    ) {
            ...
            _proto._addTouchEventListeners = function _addTouchEventListeners() {
                ...
                var move = function move(event) {
                    ...
                    if (event.touches && event.touches.length > 1) {
                        ...
                        _this3.touchDeltaX =
                            event.touches[0].clientX - _this3.touchStartX;
                    }
                };
                ...
                if (this._pointerEvent) {
                    ...
                    EventHandler.on(this._element, Event$3.POINTERUP, function(
                        event
                    ) {
                        return end(event);
                    });
                    ...
                    EventHandler.on(this._element, Event$3.TOUCHSTART, function(
                        event
                    ) {
                        return start(event);
                    });
                    EventHandler.on(this._element, Event$3.TOUCHMOVE, function(
                        event
                    ) {
                        return move(event);
                    });
                    EventHandler.on(this._element, Event$3.TOUCHEND, function(
                        event
                    ) {
                        return end(event);
                    });
            ...
            _proto._slide = function _slide(direction, element) {
                ...
                if (
                    nextElement &&
                    nextElement.classList.contains(ClassName$2.ACTIVE)
                ) {
                    this._isSliding = false;
                    return;
                }
            ...
            Carousel.dataApiClickHandler = function dataApiClickHandler(event) {
                ...
                if (
                    !target ||
                    !target.classList.contains(ClassName$2.CAROUSEL)
                ) {
                    return;
                }
    ...
    var Collapse =
        ...
        (function() {
            function Collapse(element, config) {
                ...
                var toggleList = makeArray(
                    SelectorEngine.find(Selector$3.DATA_TOGGLE)
                );

                for (var i = 0, len = toggleList.length; i < len; i++) {
                    var elem = toggleList[i];
                    var selector = getSelectorFromElement(elem);
                    var filterElement = makeArray(
            ...
            _proto.hide = function hide() {
                ...
                if (triggerArrayLength > 0) {
                    for (var i = 0; i < triggerArrayLength; i++) {
                        ...
                        if (
                            elem &&
                            !elem.classList.contains(ClassName$3.SHOW)
                        ) {
            ...
            _proto._getDimension = function _getDimension() {
                var hasWidth = this._element.classList.contains(
                    Dimension.WIDTH
                );
            ...
            _proto._getParent = function _getParent() {
                ...
                makeArray(SelectorEngine.find(selector, parent)).forEach(
                    function(element) {
        ...
        (function() {
            ...
            _proto.show = function show() {
                ...
                if (
                    "ontouchstart" in document.documentElement &&
                    !makeArray(
                        SelectorEngine.closest(parent, Selector$4.NAVBAR_NAV)
                    ).length
                ) {
            ...
            _proto._getPlacement = function _getPlacement() {
                ...
                if (parentDropdown.classList.contains(ClassName$4.DROPUP)) {
                    ...
                    parentDropdown.classList.contains(ClassName$4.DROPRIGHT)
                ) {
                    placement = AttachmentMap.RIGHT;
                } else if (
                    parentDropdown.classList.contains(ClassName$4.DROPLEFT)
                ) {
                    placement = AttachmentMap.LEFT;
                } else if (
                    this._menu.classList.contains(ClassName$4.MENURIGHT)
                ) {
            ...
            _proto._detectNavbar = function _detectNavbar() {
                return Boolean(
                    SelectorEngine.closest(this._element, ".navbar")
                );
            };
            ...
            Dropdown.clearMenus = function clearMenus(event) {
                ...
                var toggles = makeArray(
                    SelectorEngine.find(Selector$4.DATA_TOGGLE)
                );
                ...
                for (var i = 0, len = toggles.length; i < len; i++) {
                    ...
                    if ("ontouchstart" in document.documentElement) {
                        makeArray(document.body.children).forEach(function(
                            elem
                        ) {
            ...
            Dropdown.getParentFromElement = function getParentFromElement(
                element
            ) {
                return getElementFromSelector(element) || element.parentNode;
            };

            Dropdown.dataApiKeydownHandler = function dataApiKeydownHandler(
                event
            ) {
                ...
                if (
                    this.disabled ||
                    this.classList.contains(ClassName$4.DISABLED)
                ) {
                    return;
                }
    ...
    var Modal =
        ...
        (function() {
            ...
            _proto.show = function show(relatedTarget) {
                ...
                EventHandler.on(
                    this._dialog,
                    Event$6.MOUSEDOWN_DISMISS,
                    function() {
                        EventHandler.one(
                            _this._element,
                            Event$6.MOUSEUP_DISMISS,
                            function(event) {
            ...
            _proto.hide = function hide(event) {
                ...
                var transition = this._element.classList.contains(
                    ClassName$5.FADE
                );
            ...
            _proto._setScrollbar = function _setScrollbar() {
                ...
                if (this._isBodyOverflowing) {
                    ...
                    makeArray(
                        SelectorEngine.find(Selector$5.FIXED_CONTENT)
                    ...
                    makeArray(
                        SelectorEngine.find(Selector$5.STICKY_CONTENT)
                    ).forEach(function(element) {
    ...
    var Tooltip =
        ...
        (function() {
            ...
            _proto._addAttachmentClass = function _addAttachmentClass(
                attachment
            ) {
            ...
            _proto._enter = function _enter(event, context) {
                ...
                if (
                    context
                        .getTipElement()
                        .classList.contains(ClassName$6.SHOW) ||
            ...
            _proto._getConfig = function _getConfig(config) {
                var dataAttributes = Manipulator.getDataAttributes(
                    this.element
                );
    ...
    var ScrollSpy =
        ...
        (function() {
            function ScrollSpy(element, config) {
                ...
                EventHandler.on(this._scrollElement, Event$9.SCROLL, function(
                    event
                ) {
    ...
    EventHandler.on(window, Event$9.LOAD_DATA_API, function() {
        makeArray(SelectorEngine.find(Selector$8.DATA_SPY)).forEach(function(
            spy
        ) {
        ...
        (function() {
                ...
                if (listElement) {
                    var itemSelector =
                        ...
                        listElement.nodeName === "OL"
                            ...
                            : Selector$9.ACTIVE;
                    previous = makeArray(
                        SelectorEngine.find(itemSelector, listElement)
                    );
            ...
            _proto._activate = function _activate(
                ...
                var isTransitioning =
                    callback &&
                    active &&
                    active.classList.contains(ClassName$9.FADE);
            ...
            _proto._transitionComplete = function _transitionComplete(
                ...
                if (
                    ...
                    if (dropdownElement) {
                        makeArray(
                            SelectorEngine.find(Selector$9.DROPDOWN_TOGGLE)
